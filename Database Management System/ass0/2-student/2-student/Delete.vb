            ...
            Else
                ...
                For i As Integer = 0 To arrDept(idx).totalstudents - 1
                    If temproll = arrStu(idx, i).roll And arrStu(idx, i).isDeleted = 0 Then
                        result1.Text = "ENTRY DELETED SUCCESSFULLY" & vbCrLf & "ROLL: " & arrStu(idx, i).roll & vbCrLf & "NAME: " & arrStu(idx, i).name & vbCrLf & "DEPT CODE: " & arrStu(idx, i).dcode & vbCrLf & "ADDRESS: " & arrStu(idx, i).address & vbCrLf & "PHONE: " & arrStu(idx, i).phone & vbCrLf
                        flag = 1
                        arrStu(idx, i).isDeleted = 1
                    End If
                Next i
                If flag = 0 Then
